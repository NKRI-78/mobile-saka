...
class ColorResources {
  ...
  static const Color green = Color(0xFF328F37);
  static const Color gainsBoro = Color(0xffDBDBDB);
  static const Color btnPrimarySecond = Color(0xffDD0000);
  static const Color hintColor = Color(0xff9E9E9E);
  static const Color indicatorOnboarding = Color(0xffDA251D);
  static const Color splash = Color(0xffD9AF80);
