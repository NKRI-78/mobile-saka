  ...
  Future<void> sendSos(BuildContext context, {
    ...
    try {
      ...
      await dio.post("${AppConstants.baseUrl}/data/sos", data: {
        ...
        "txt1": "${getTranslated(content, context)} ${getTranslated(obj, context)} ${lp.getCurrentNameAddress.replaceAll("\n", " ")}",
        "Message": "${content}-${obj}-${lp.getCurrentNameAddress.replaceAll("\n", " ")}",
