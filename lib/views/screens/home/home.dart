                ...
                children: [
                  Consumer<ProfileProvider>(
                    builder: (BuildContext context, ProfileProvider profileProvider, Widget? child) {
                      ...
                      return SizedBox(
                        width: 200.0,
                        child: Text(profileProvider.userProfile.fullname!,
                          maxLines: 1,
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(getTranslated("TOPUP", context),
                      style: robotoRegular.copyWith(
                        fontSize: Dimensions.fontSizeDefault,
                        fontWeight: FontWeight.bold,
                        color: ColorResources.white
                ...
                Consumer<EcommerceProvider>(
                  builder: (__, notifier, _) {
                    if(notifier.balanceStatus == BalanceStatus.loading) {
                      return Text(CurrencyHelper.formatCurrency(0),
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeDefault,
                          color: ColorResources.white
                        ),
                    ...
                    if(notifier.balanceStatus == BalanceStatus.error) {
                      return Text(CurrencyHelper.formatCurrency(0),
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeDefault,
                          color: ColorResources.white
                    ...
                    return Text(CurrencyHelper.formatCurrency(notifier.balance),
                      style: robotoRegular.copyWith(
                        fontSize: Dimensions.fontSizeDefault,
                        color: ColorResources.white
                      ),
          ...
          child: Material(
            ...
            child: InkWell(
              ...
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/${menus[i]["asset"]}',
                    width: 20.0,
                    height: 20.0, 
                  ),
