...
class OtpScreenState extends State<OtpScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      if (mounted) {
        setState(() {
          if (widget.forgotPasswordMode) {
            Provider.of<AuthProvider>(context, listen: false).changeEmailName =
                widget.initialEmail ?? "";
          } else {
            Provider.of<AuthProvider>(context, listen: false).changeEmailName =
                prefs.getString("email_otp")!;
          }
          loading = false;
        });
      }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: RichText(
                    text: TextSpan(
                      text:
                          "Mohon masukkan 4 digit kode telah dikirim ke Alamat E-mail ",
                      children: [
                        TextSpan(
                            ...
                            Flexible(
                              child: Container(
                                ...
                                child: TextButton(
                                  ...
                                  child:
                                      authProvider.applyChangeEmailOtpStatus ==
                                          ApplyChangeEmailOtpStatus.loading
                                      ? SizedBox(
                                          width: 18.0,
                                          height: 18.0,
                                  ...
                                  onPressed: () {
                                    authProvider.applyChangeEmailOtp(
                                      context,
                                      globalKey,
                                    );
                                  },
                ...
                authProvider.whenCompleteCountdown == "completed"
                    ? Row(
                        ...
                        children: [
                          Text(
                            getTranslated("DID_NOT_RECEIVE_CODE", context),
                            style: robotoRegular.copyWith(
                              color: ColorResources.black,
                              fontSize: Dimensions.fontSizeSmall,
                            ),
                          ...
                          TextButton(
                            onPressed: () =>
                                authProvider.resendOtpCall(context, globalKey),
                            child:
                                authProvider.resendOtpStatus ==
                ...
                Container(
                  ...
                  child: TextButton(
                    ...
                    child:
                        authProvider.verifyOtpStatus == VerifyOtpStatus.loading
                    ...
                    onPressed: () {
                      if (widget.forgotPasswordMode) {
                        authProvider.verifyOtpForgotPassword(
                          context,
                          authProvider.changeEmailName,
                        );
                      } else {
                ...
                widget.forgotPasswordMode
                    ...
                    : Container(
                        ...
                        child: TextButton(
                          child: Text(
                            getTranslated("CHANGE_EMAIL", context),
                            style: robotoRegular.copyWith(
                              color: ColorResources.primaryOrange,
                              fontSize: Dimensions.fontSizeSmall,
                              fontWeight: FontWeight.bold,
