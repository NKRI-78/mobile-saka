...
class SignUpSocialMediaScreen extends StatefulWidget {
  final String fullName;
  final String emailAddress;
  final String profilePic;
  final String type;
  const SignUpSocialMediaScreen({ 
...
class _SignUpSocialMediaScreenState extends State<SignUpSocialMediaScreen> {
  ...
  Future<List<Province>> getRegionRegister() async {
    try {
      ...
      || e.response!.statusCode == 502) {
        ShowSnackbar.snackbar("(${e.response!.statusCode}) : Internal Server Error (${e.response!.data})", "", ColorResources.error);
      }
    } catch(e, stacktrace) {
  ...
  void initState() {
    super.initState();
    fullnameC = TextEditingController(text: widget.fullName);
    usernameC = TextEditingController();
    emailC = TextEditingController(text: widget.emailAddress);
