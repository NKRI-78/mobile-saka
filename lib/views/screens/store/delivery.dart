        ...
        builder: (BuildContext context, StoreProvider storeProvider, Widget? child) {
          ...
          return Stack(
            ...
            ListView(
              ...
              ...storeProvider.cartProductStoresActive.asMap().map((int i, StoreElement data) => MapEntry(i,
                Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(16.0),
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        bool active = false;
                        var s =  storeProvider.cartData.stores!.where((el) => el.isActive == true).toList();
                        for (int i = 0; i < s.length; i++) {
                          if (s[i].shippingRate!.serviceType != "") {
                            active = true;
                          } else {
                            active = false;
                            break;
