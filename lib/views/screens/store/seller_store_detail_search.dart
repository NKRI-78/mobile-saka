...
class SellerDetailSearchProductScreen extends StatefulWidget {
  final String typeProduct;
  final String storeId;

  const SellerDetailSearchProductScreen({
    Key? key,
    required this.typeProduct,
    required this.storeId
  }) : super(key: key);
  @override
  _SellerDetailSearchProductScreenState createState() => _SellerDetailSearchProductScreenState();
}

class _SellerDetailSearchProductScreenState extends State<SellerDetailSearchProductScreen> {
  GlobalKey<ScaffoldState> globalKey = GlobalKey<ScaffoldState>();
  
  late ScrollController scrollC;

  Future<void> getDataSearch(String text) async {
    await context.read<StoreProvider>().getAllSearchProductSellerDetail(context, text, 0, widget.storeId);
  }
  ...
  Widget widgetDataSearch() {
    return context.watch<StoreProvider>().allProductSellerSearchStatus == AllProductSellerSearchStatus.empty 
    ? emptyTransaction() 
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(
                            width: 100.0,
                            child: Text(
                              storeProvider.allProductSearch[i].name!,
